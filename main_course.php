...
$query = "SELECT recipetitle, recipeimage, recipedescription, recipeingredients, recipeinstructions 
          ...
          WHERE LOWER(recipecategory) = 'maincourse'";

if (!empty($searchTerm)) {
    $query .= " AND (LOWER(recipetitle) LIKE '%$searchTerm%' 
              OR LOWER(recipedescription) LIKE '%$searchTerm%')";
}
...
<html lang="en">
  <head>
    ...
    <title>Dish Discoveries - Main Course</title>
  ...
  <body>
          ...
          ?> 
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="main_course.php#<?php echo $id; ?>">Main Course</a></li>
    ...
    <!-- Main Course Recipes -->
    <div class="container">
      <h2 class="mb-3">Main Course - Recipes</h2>
      <div class="row">
        <?php
        if ($result->num_rows > 0) {
            ...
            echo "<p>No recipes found for your search.</p>";
        }
        ?>
      </div>
    </div>
    ...
    <div id="reviewcontainer">
      ...
      if ($_SERVER['REQUEST_METHOD'] === 'POST')
      {
       ...
       $sql="INSERT INTO tbl_reviews (reviewtitle, rating, review, created_at,user_id) VALUES ('$reviewtitle', '$rating',
      ...
      $review = "SELECT reviewtitle, rating, review, created_at,user_id FROM tbl_reviews ORDER BY created_at DESC LIMIT 3";
